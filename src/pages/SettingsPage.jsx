...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! How's it is going?", isSent: false },
  {
    id: 2,
...
const SettingsPage = () => {
  ...
  return (
    <div className=" h-screen mx-auto container px-4 pt-15 max-w-5xl">
              ...
              <div className=" bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className=" px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className=" flex items-center gap-3">
                    ...
                    <div>
                      <h3 className=" font-medium text-sm">Mahmoud Qedais</h3>
